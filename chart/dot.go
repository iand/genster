...
// 		d.generations[generation] = append(d.generations[generation], in.ID)
// 		done[in.ID] = true
// 	}
...
// 		}
// 		famNode := &DotNode{
// 			ID:      fmt.Sprintf("%s_%s_fam", in.ID, fam.ID),
// 			Comment: in.Name,
// 			Attrs: []DotAttrFunc{
// 				DotKV("shape", "point"),
// 				DotKV("style", "invis"),
...
// 	relNode := &DotNode{
// 		ID:      fmt.Sprintf("%s_%s_rel", in.ID, fam.ID),
// 		Comment: in.Name,
// 		Attrs: []DotAttrFunc{
// 			DotKV("shape", "none"),
// 			func(b *DotBuffer) {
...
// 	detailsNode := &DotNode{
// 		ID:      fmt.Sprintf("%s_%s_details", in.ID, fam.ID),
// 		Comment: in.Name,
// 		Attrs: []DotAttrFunc{
// 			DotKV("shape", "none"),
// 			func(b *DotBuffer) {
